...
class Subscription(Base):
    ...
    plan_id: Mapped[uuid.UUID | None] = mapped_column(sa.Uuid, sa.ForeignKey("plans.id"))
    status: Mapped[str] = mapped_column(sa.String, nullable=False, default="trialing")
    billing_cycle: Mapped[str | None] = mapped_column(sa.String, default="monthly")
    payment_provider: Mapped[str | None] = mapped_column(sa.String)
    external_subscription_id: Mapped[str | None] = mapped_column(sa.String)
    ...
    cancel_at_period_end: Mapped[bool | None] = mapped_column(sa.Boolean, default=False)
    created_at: Mapped[datetime | None] = mapped_column(sa.DateTime(timezone=True))
    updated_at: Mapped[datetime | None] = mapped_column(sa.DateTime(timezone=True))
