    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="bg-[#1E3340] border-b border-[#32576F] px-6 py-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[#7A9BAD] text-sm">Revenue por DineroDisponible</p>
        </div>
      </div>
      ...
      <main className="flex-1 px-6 py-6 space-y-6">
        ...
        {data && (
          <>
              ...
              <KpiCard
                ...
                value={fmt(
                  data.serie_temporal.length > 0
                    ? data.total_periodo / data.serie_temporal.length
                    : 0
                )}
            ...
            {/* Revenue over time */}
            <ChartContainer
              title="Revenue por día"
              subtitle="DineroDisponible acumulado"
              exportFileName={`ventas_serie_${tenantId}`}
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <ChartContainer title="Revenue por método de pago" exportFileName={`ventas_metodo_${tenantId}`}>
            ...
            {/* Top products table */}
            <ChartContainer
              title="Top 30 productos por revenue"
              subtitle={`${data.top_productos.length} productos en el período seleccionado`}
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#32576F]">
                      {['Producto', 'Talle', 'Color', 'Revenue', 'Unidades', '% Total'].map((h) => (
                        ...
                        <td className="py-2 px-3">
                          <div className="flex items-center gap-2">
                            <div className="h-1.5 bg-[#32576F] rounded-full w-16">
                              <div
                                className="h-1.5 bg-[#ED7C00] rounded-full"
