        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-[#1E3340] border border-[#32576F] rounded-2xl overflow-hidden">
            <div className="px-5 py-4 border-b border-[#32576F] flex items-center justify-between">
              ...
              <Link href="/dashboard/clientes" className="text-xs text-[#ED7C00] hover:underline">
                Ver todos →
              </Link>
            </div>
              ...
              <Table>
                ...
                <TableBody>
                  {tenants.items.map((t: {
                    ...
                    <TableRow key={t.id}>
                      <Td>
                        <Link href={`/dashboard/clientes/${t.id}`}
          ...
          <div className="bg-[#1E3340] border border-[#32576F] rounded-2xl">
            <div className="px-5 py-4 border-b border-[#32576F] flex items-center justify-between">
              ...
              <Link href="/dashboard/usuarios" className="text-xs text-[#ED7C00] hover:underline">
                Ver todos →
              </Link>
            </div>
